<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1 alt="exhibition title">Rare Books? Expect the Unexpected</h1>
        <div id="banner-block">
            <div id="rare-banner" class="exhibition-image"></div>
        </div>
        <h4 id="individual-exhibition-h" class="right-align-h" alt="exhibition details and location">30 November 2018 - 2 March 2019 <br> Ground Floor <br> Main Library Exhibition Gallery </h4>
