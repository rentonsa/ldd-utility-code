<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1>Object Lessons</h1>
        <div id="object-banner" class="exhibition-image"></div>
        <h4 id="individual-exhibition-h" class="right-align-h">7th June 2003 - 19th July 2003<br>Talbot Rice Gallery</h4>
        ...
        <h4 class="object-h">Resources</h4>
            ...
            <a href="http://images.is.ed.ac.uk/luna/servlet/UoEhal~2~2" target = "_blank" title = "High res images" alt = "High res images">
