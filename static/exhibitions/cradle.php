<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1 alt="exhibition title">Edinburgh 300: Cradle of Chemistry</h1>
        <div id="cradle-banner" class="exhibition-image"></div>
        <h4 id="individual-exhibition-h" class="right-align-h" alt="exhibition details and location">1st August 2013 - 2nd November 2014<br>Exhibition Gallery<br>Main Library<br>George Square </h4>
        <p id="individual-exhibition-p" class="right-align-p" alt="exhibition curator">
            Curated by: Dr Andy Alexander (Senior Lecturer in Chemical Physics at the University of Edinburgh)
        </p>
        <br>
