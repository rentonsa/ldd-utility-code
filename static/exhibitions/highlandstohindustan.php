<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1 alt="exhibition title">Highlands to Hindustan: Indian Art from University of Edinburgh Collections</h1>
        <div id="highlands-banner" class="exhibition-image"></div>
        <h4 id="individual-exhibition-h" class="right-align-h" alt="exhibition details and location">28th July 2017 - 4th November 2017<br>Exhibition Gallery<br>Main Library<br>George Square</h4>
