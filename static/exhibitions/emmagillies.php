<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1 alt="exhibition title">Emma Gillies: Rediscovered</h1>
        <div id="gillies-banner" class="exhibition-image"></div>
        <h4 id="individual-exhibition-h" class="right-align-h" alt="exhibition details and location">5th December 2014 - 7th March 2015<br>Exhibition Gallery<br>Main Library<br>George Square</h4>
        <p id="individual-exhibition-p" class="right-align-p" alt="exhibition curator">
            Curated by: Gordon Brennan (Edinburgh College of Art, Director of Undergraduate Studies)
        </p>
        <br>
