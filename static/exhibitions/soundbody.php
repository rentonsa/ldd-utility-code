<div class="content" id="static-exhibition">
    <div class="content byEditor">
        <h1 alt="exhibition title">Sound Body, Sound Mind: A History of Healing Through the University’s Collections</h1>
        <h4 id="individual-exhibition-h" class="right-align-h" alt="exhibition details and location">6th April - 1st July 2017<br />
            Exhibition Gallery<br>Main Library<br>George Square<br />
        </h4>
        <div id="sound-banner" class="exhibition-image"></div>
        ...
        <a href="<?php echo base_url() ?>past#soundbody-anchor" alt="link back to full past exhibiton list" title="Link back to full past exhibiton list">
