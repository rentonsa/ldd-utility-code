    ...
    <div class="about-container">
        ...
        <div class="information-container col-xs-12 col-md-8 col-md-offset-2">
            <p>All universities hold collections of objects. Some have been collected by the universities themselves or donated by founders, supporters, ex-students or friends.
                Others have been given to the universities to look after on behalf of other organisations, groups or landowners/important local families from the past.</p>

            <p>Most of these collections are - or have at one time been - used to support teaching, learning and research, and some are there to improve the university environment for
                students. Most are also available for you to see either in museums, on campus, or by appointment with the university.</p>

            <p>University museums will also hold events, exhibitions and activities open for anyone to attend.</p>

            <p>For more information on how to visit each of the collections, go to our Visit drop down in the top menu. </p>

            <h1>Who is UMIS?</h1>

            <p>University Museums in Scotland (UMIS) is a network of the 9 Scottish university museum services that have achieved
            ...
            <p>
            UMIS works to represent and promote university museums both within Scotland and beyond.
            </p>
            <h2>Members</h2>
            ...
            <h2>Key UMIS staff</h2>
            <ul>
                <li>Convener: Jacky MacBeath, University of Edinburgh</li>
                <li>Secretary: Jane Cameron, University of Stirling</li>
                <li>Teasurer: Mungo Campbell, University of Glasgow</li>
            ...
            <p>
                UMIS has a  <a href="https://www.umis.ac.uk/about/constitution.html" alt-text="UMIS constitution" title="UMIS constitution" target="_blank">constitution</a>
                that outlines how we are structured, how we operate, and what our aims are.</p>
