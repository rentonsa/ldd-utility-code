...
image_folder = Path("images-test")

# Specify the Path to the csv
csv_path = "image_rights-test.csv"


# DSPACE Credentials

#LIVE: api_base_url = "https://digitalpreservation.is.ed.ac.uk"
...
#LIVE: as_base_url = "http://lac-archivesspace-live2.is.ed.ac.uk"
as_base_url = "http://lac-archivesspace-test1.is.ed.ac.uk"
as_user = input("Enter your ArchivesSpace username:")
as_password = input("Enter your ArchivesSpace password:")
#LIVE: as_archival_repo = "2"
as_archival_repo = "18"
as_url_port = "8089"
...
def main():
    ...
    for image in images:
         if "name" in image and "id" in image and "Title of Photo" in image and "Rights Statement" in image:
             ...
             as_agent = get_as_agent(as_base_url, as_url_port, as_session_id, image['AS_ID'])
             ...
             if "notes" in as_agent and as_agent['notes']:
                 ...
                 update_as_agent(as_base_url, as_url_port, as_session_id, image['AS_ID'], as_agent, link_to_image,
