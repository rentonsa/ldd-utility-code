...
<div class="all container-fluid">
    <h1>Get IIIF URLs for Image IDs</h1>

    <h2>Copy image names from monthly file, one per row- generally Work Record ID + "c" + "-xxxx" (if applicable).
    </h2>
    <div class="box">
        <form name="form" method="post" action="give_url.php">
            <h4>Image List</h4>
