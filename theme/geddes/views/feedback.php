<div class="feedback_form">
    ...
    <p>For suggestions or questions relating specifically to this website please contact: <a href="mailto:<?php echo $this->config->item('skylight_adminemail'); ?>"><?php echo $this->config->item('skylight_adminemail'); ?></a>.</p>
    ...
    <p>
        If you have any questions, please contact: <a href="mailto:<?php echo $this->config->item('skylight_adminemail'); ?>"><?php echo $this->config->item('skylight_adminemail'); ?></a>
    </p>
