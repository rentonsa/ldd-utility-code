            ...
            <footer>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 footer-logos ">
                    <div class="center-block" id ="footer-logos-area">
                        ...
                        <a href="https://wellcome.ac.uk/" target="_blank" title="The Wellcome Trust" alt-text="The Wellcome Trust"><div class="wellcome-logo"></div></a>
                ...
                <div class="col-sm-12 col-xs-12 footer-disclaimer">
                    <div class="center-block footer-policies">
                        ...
                        <p class="footer-copyright">Unless explicitly stated otherwise, all material is copyright &copy; <?php echo date("Y"); ?>
                            <a href="http://www.ed.ac.uk" title="University of Edinburgh Home" target="_blank">University of Edinburgh</a> or
                            <a href="http://www.strath.ac.uk" title="University of Strathclyde Home" target="_blank">University of Strathclyde</a>.</p>
                    </div>
                </div>
            </footer>
        </div>
