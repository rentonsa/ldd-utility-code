        <footer>
            ...
            <div class="footer-disclaimer">
                <div class="footer-policies">
                    ...
                    <p class="footer-copyright">Unless explicitly stated otherwise, all material is copyright &copy; <?php echo date("Y"); ?> <a href="https://www.ed.ac.uk" title="University of Edinburgh Home" target="_blank">University of Edinburgh</a> or <a href="http://www.nls.ac" title="National Library of Scotland Home" target="_blank">National Library of Scotland</a>.</p>
                </div>
            </div>
            <div class="footer-logos">
                ...
                <a href="https://www.nls.uk/" target="_blank"><div class="nls-logo"></div></a>
            </div>
        </footer>
    </div>