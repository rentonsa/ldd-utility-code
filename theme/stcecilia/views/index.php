<div class="container-fluid">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="galleries" class="grid"<?php /* Prevent script from loading on homepage */ if($this->config->item('skylight_appname') != str_replace('/', '', $_SERVER['REQUEST_URI'])) { ?> data-masonry='{ "itemSelector": ".grid-item index-grid", "percentPosition": true, "columnWidth": .grid-sizer}'<?php } ?>>
            ...
            <a href="./search/%22Keyboard+grouping%22"><div id="gallerykb" class="grid-item index-grid"><div class="gallery-title"><h4>Keyboards</h4></div>
            <div class="mob-title"><h4>Keyboards</h4></div></div></a>
            <a href="./search/%22Western+percussion+grouping%22"><div id="gallerywespe" class="grid-item index-grid"><div class="gallery-title"><h4>Western Percussion</h4></div>
            <div class="mob-title"><h4>Western Percussion</h4></div></div></a>
            <a href="./search/%22Ethnographic+percussion+grouping%22"><div id="galleryethpe" class="grid-item index-grid"><div class="gallery-title"><h4>Non-western Percussion</h4></div>
