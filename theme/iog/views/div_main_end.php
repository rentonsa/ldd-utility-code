            ...
            <div class="footer-links">
                ...
                <div class="site-links">
                    <div class="footer-logo">
                        <a href="https://www.ed.ac.uk" target="_blank" class="uoelogo" title="University of Edinburgh Home"></a>
                    </div>
                    ...
                    <div class="iog-logo">
                         <a href="http://www.institute-of-governance.org" target="_blank" class="ioglogo" title="Institute of Governance Home"></a>
                    </div>
                    <div class="clearfix"></div>
                    <div class="copyright-policies">
                        Unless explicitly stated otherwise, all material is copyright &copy; <?php echo date("Y"); ?> <a href="https://www.ed.ac.uk" title="University of Edinburgh Home" target="_blank" class="last">University of Edinburgh</a>
                    </div>
                </div>
            </div>
        </footer>
